 ...
 */
    ...
    public class CircularImageView extends ImageView {
        ...
        private static final float DEFAULT_SHADOW_RADIUS = 15.0f;
        ...
        private void init(Context context, AttributeSet attrs, int defStyleAttr) {
            ...
            // Init Border
            if (attributes.getBoolean(R.styleable.CircularImageView_civ_border, false)) {
            ...
            // Init Shadow
            //  if (attributes.getBoolean(R.styleable.CircularImageView_civ_shadow, true)) {
