...
public class Registration extends AppCompatActivity {
    ...
    EditText e12, e14, e18,e15;
    Button b12;
    String username, srno, password, gender,conpass;
    Bitmap bmp;
    int cameraData;
        ...
        b12.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (cancel) {
                    ...
                    if(b){
                    r = validateForm(username, password, srno,conpass);}
                    else
                    {
    ...
    private int validateForm(String u, String p, String srno,String conpass) {
